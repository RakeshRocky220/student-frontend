      ...
      <div className="row">
        <div className="col-12">
          <div
            ...
            className="row mt-2 mx-1 rounded 30px"
          >
            ...
            <div className="col-6">
              <div className="mt-4">
                <NavLink to={`/dashboard/addstudent/${obj.email}`}>
                  <button className="btn btn-dark btn-sm mx-3">
                    AddStudent
                  </button>
                </NavLink>
                ...
                <NavLink to={`/dashboard/students/${obj.headToStandard}`}>
                  <button className="btn btn-dark btn-sm mx-3">Students</button>
                </NavLink>
                <NavLink>
                  <button
          ...
          <div className="row">
            <div
              style={{ position: `absolute`, top: `240px`, left: `500px` }}
              id="romantic"
            >
              {b ? (
                <div>
                  <h1 className="font" style={{ fontWeight: `bolder` }}>
                    {" "}
                    Click To Start
                  </h1>{" "}
                  <i
                ...
                <div>
                  <div
                    ...
                    style={{ fontSize: `220px`, color: `black` }}
                  ></div>
                </div>
              )}
            </div>
