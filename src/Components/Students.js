...
<div className="row">
      ...
      <div className="container m-3" style={{ overflowX: 'auto', maxHeight: `400px`,maxWidth:`1080px` }}>
        
        <div style={{ paddingBottom: `10px`, width: `100%` }} className="row rounded 30px mx-1  mt-2">
